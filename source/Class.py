...
def Classification():
    ...
    st.markdown("<p style='text-align: center; color: black; font-size:20px;'><span style='font-weight: bold'>Problem Statement: </span>Application to Classificaiton model</p>", unsafe_allow_html=True)
    ...
    with col13:
        vAR_problem = st.selectbox("",["Select Problem Satement","Student (pass/fail) classification","Bank (approved/denied) classification"])
    with col14:
        st.write("")
    with col15:
        st.write("")
